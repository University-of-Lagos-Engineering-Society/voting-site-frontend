    ...
    <main className="relative flex min-h-screen  flex-col bg-[#141414] px-4 py-6 text-white">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-8 mt-4 lg:mt-16">
          ...
          <Card title="Results" view to="/results" />
...
const Card = ({ title, number, to, view }: CardProps) => (
  <Link href={to} className="w-full py-6 px-4 bg-card cursor-pointer z-50">
    <div className="flex flex-row gap-4 lg:gap-6 mb-6 items-center">
      ...
      {view && (
        <h2 className="text-[#717171] work-sans">View Results</h2>
      )}

    </div>

    <div className="text-[#717171]">Tap to
      {view ? ' view' : ' vote'}
    </div>
  </Link>
);
