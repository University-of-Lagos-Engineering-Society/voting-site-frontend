...
import { useGetFaceOfDepartmentSSGQuery } from "@/redux/slices/general";
    ...
    <div className="flex flex-col gap-8 mt-4 lg:mt-16">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between">
        <div>
          ...
          Cast your vote for the Face Of Department SSG
        </p>
...
export default FaceOfDepartmentSSG;
