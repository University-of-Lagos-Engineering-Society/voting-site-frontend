...
import { useGetFaceOfDepartmentSVYQuery } from "@/redux/slices/general";
    ...
    <div className="flex flex-col gap-8 mt-4 lg:mt-16">
      <div className="mb-10 flex flex-col gap-6">
        ...
        <div>
          ...
          Cast your vote for the Face Of Department SVY
        </p>
...
export default FaceOfDepartmentSVY;
