...
import { useGetULESVolunteerOfTheYearAwardQuery } from "@/redux/slices/general";
...
const ULESVolunteerOfTheYearAward = ({
  index,
  candidate,
  setCandidate,
  setIndex,
  ...
  const { data, isLoading, isError } = useGetULESVolunteerOfTheYearAwardQuery();
  
  return (
    <div className="flex flex-col gap-8 mt-4 lg:mt-16">
      <div className="mb-10 flex flex-col gap-6">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold paris-pro">
          Award : ULES Volunteer of the Year
        </h1>
        <ImageSelectoooor image_name="ULESVolunteerofTheYear" />
      </div>

      <div className="w-full flex flex-col lg:flex-row items-center justify-between">
        <div>
          <p className="work-sans text-xl lg:text-2xl">
          Cast your vote for the ULES Volunteer of the Year
        </p>
...
export default ULESVolunteerOfTheYearAward;
