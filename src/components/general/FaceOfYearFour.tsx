...
import { useGetFaceOfYearFourQuery } from "@/redux/slices/general";
...
const FaceOfYearFour = ({
  index,
  candidate,
  setCandidate,
  setIndex,
}: FormProps) => {
  const { data, isLoading, isError } = useGetFaceOfYearFourQuery();
    ...
    <div className="flex flex-col gap-8 mt-4 lg:mt-16">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between">
        <div>
          ...
          Cast your vote for the Face of Year Four
        </p>
