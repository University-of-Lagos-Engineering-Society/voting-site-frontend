...
import { useGetULESPersonOfTheYearAwardQuery } from "@/redux/slices/general";
...
const ULESPersonOfTheYearAward = ({
  index,
  candidate,
  setCandidate,
  setIndex,
}: FormProps) => {
  const { data, isLoading, isError } = useGetULESPersonOfTheYearAwardQuery();
  
  return (
    <div className="flex flex-col gap-8 mt-4 lg:mt-16">
      <div className="mb-10 flex flex-col gap-6">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold paris-pro">
          Award : ULES person of the Year
        </h1>
        <ImageSelectoooor image_name="ULESPersonOfTheYear" />
      </div>

      <div className="w-full flex flex-col lg:flex-row items-center justify-between">
        <div>
          <p className="work-sans text-xl lg:text-2xl">
          Cast your vote for the ULES person of the Year
        </p>
...
export default ULESPersonOfTheYearAward;
