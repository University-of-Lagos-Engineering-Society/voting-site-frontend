...
import { useGetOutstandingAcademicPerformanceAwardQuery } from "@/redux/slices/grad";
...
const OutstandingAcademicPerformanceAward = ({ index, candidate, setCandidate, setIndex }: FormProps) => {
    const { data, isLoading, isError } = useGetOutstandingAcademicPerformanceAwardQuery();
    return (
