...
import { useGetStartupVisionaryAwardGradQuery } from "@/redux/slices/grad";
...
const StartupVisionaryAward = ({ index, candidate, setCandidate, setIndex }: FormProps) => {
    const { data, isLoading, isError } = useGetStartupVisionaryAwardGradQuery();
    return (
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-between">
          <div>
            <p className="work-sans text-xl lg:text-2xl">
              Cast your vote for the Startup Visionary Award
            </p>
...
export default StartupVisionaryAward;
