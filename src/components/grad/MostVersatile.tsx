...
import { useGetMostVersatileGradQuery } from "@/redux/slices/grad";
...
const MostVersatile = ({ index, candidate, setCandidate, setIndex }: FormProps) => {
    const { data, isLoading, isError } = useGetMostVersatileGradQuery();
    return (
        <div className="flex flex-col gap-8 mt-4 lg:mt-16">
            ...
            <div>
                <p className="work-sans text-xl lg:text-2xl">
                    Cast your vote for the Most Versatile
                </p>
