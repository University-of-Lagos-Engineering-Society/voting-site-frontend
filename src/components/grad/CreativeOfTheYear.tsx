...
import { useGetCreativeOfTheYearGradQuery} from "@/redux/slices/grad";
...
const CreativeOfTheYear = ({
  index,
  candidate,
  setCandidate,
  setIndex,
}: FormProps) => {
  const { data, isLoading, isError } = useGetCreativeOfTheYearGradQuery();
  return (
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between">
        <div>
          <p className="work-sans text-xl lg:text-2xl">
            Cast your vote for the Creative of The Year
          </p>
...
export default CreativeOfTheYear;
