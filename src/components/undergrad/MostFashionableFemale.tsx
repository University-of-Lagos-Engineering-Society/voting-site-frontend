...
import { useGetMostFashionableFemaleQuery } from "@/redux/slices/undergrad";
...
const MostFashionableFemale = ({ index, candidate, setCandidate, setIndex }: FormProps) => {
    const { data, isLoading, isError } = useGetMostFashionableFemaleQuery();
    return (
      <div className="flex flex-col gap-8 mt-4 lg:mt-16">
        <div className="mb-10 flex flex-col gap-6">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold paris-pro">
            Award : Most Fashionable Female
                </h1>
                <ImageSelectoooor image_name="MostFashionableFemaleUndergrad" />
        </div>

        <div>
          <p className="work-sans text-xl lg:text-2xl">
            Cast your vote for the Most Fashionable Female
          </p>
...
export default MostFashionableFemale;
