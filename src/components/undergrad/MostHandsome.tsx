...
import { useGetMostHandsomeQuery } from "@/redux/slices/undergrad";
...
const MostHandsome = ({ index, candidate, setCandidate, setIndex }: FormProps) => {
    const { data, isLoading, isError } = useGetMostHandsomeQuery();
    return (
        ...
        <div className="mb-10 flex flex-col gap-6">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold paris-pro">
            Award : Most Handsome
                ...
                <ImageSelectoooor image_name="MostHandsomeUndergrad" />
        </div>

        <div>
          <p className="work-sans text-xl lg:text-2xl">
            Cast your vote for the Most Handsome
          </p>
