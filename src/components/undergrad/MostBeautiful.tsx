...
import { useGetMostBeautifulQuery } from "@/redux/slices/undergrad";
...
const MostBeautiful = ({ index, candidate, setCandidate, setIndex }: FormProps) => {
    const { data, isLoading, isError } = useGetMostBeautifulQuery();
    return (
      <div className="flex flex-col gap-8 mt-4 lg:mt-16">
        <div className="mb-10 flex flex-col gap-6">
          ...
          <ImageSelectoooor image_name="MostBeautifulUndergrad" />
        </div>

        <div className="w-full flex flex-col lg:flex-row items-center justify-between">
          <div>
            <p className="work-sans text-xl lg:text-2xl">
              Cast your vote for the Most Beautiful
            </p>
