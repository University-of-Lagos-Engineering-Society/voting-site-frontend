...
import { useGetLifeOfThePartyQuery, } from "@/redux/slices/undergrad";
...
const LifeOfTheParty = ({ index, candidate, setCandidate, setIndex }: FormProps) => {
    ...
    <div className="flex flex-col gap-8 mt-4 lg:mt-16">
      <div className="mb-20">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold paris-pro">
          Award : Life of the Party
        </h1>
      </div>

      <div>
        <p className="work-sans text-xl lg:text-2xl">
          Cast your vote for the Life of the Party
        </p>
