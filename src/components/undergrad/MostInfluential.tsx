...
import { useGetMostInfluentialQuery} from "@/redux/slices/undergrad";
...
const MostInfluential = ({
  ...
  const { data, isLoading, isError } = useGetMostInfluentialQuery();
  return (
    <div className="flex flex-col gap-8 mt-4 lg:mt-16">
      <div className="mb-10 flex flex-col gap-6">
        ...
        <ImageSelectoooor image_name="MostInfluentialUndergrad" />
      </div>
...
export default MostInfluential;
