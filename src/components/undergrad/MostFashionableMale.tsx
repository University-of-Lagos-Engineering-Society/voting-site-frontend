...
import { useGetMostFashionableMaleQuery } from "@/redux/slices/undergrad";
...
const MostFashionableMale = ({ index, candidate, setCandidate, setIndex }: FormProps) => {
    const { data, isLoading, isError } = useGetMostFashionableMaleQuery();
    return (
      <div className="flex flex-col gap-8 mt-4 lg:mt-16">
        <div className="mb-10 flex flex-col gap-6">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold paris-pro">
            Award : Most Fashionable Male
          </h1>
          <ImageSelectoooor image_name="MostFashionableMaleUndergrad" />
        </div>

        <div className="w-full flex flex-col lg:flex-row items-center justify-between">
          <div>
            <p className="work-sans text-xl lg:text-2xl">
              Cast your vote for the Most Fashionable Male
            </p>
...
export default MostFashionableMale;
